...
- concise notes in `reports/figures/README.md` or a nearby markdown report

## Workflow

1. Read `.sennen/config.yaml` and `reports/data_quality/` if they exist.
...
5. Write concise visualization notes in `reports/figures/README.md` or a nearby markdown report.
