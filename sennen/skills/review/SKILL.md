...
1. Read `.sennen/config.yaml`, `config/metrics/metrics.yaml`, `config/split/split.yaml`, `config/preprocess/pipeline.yaml`, and `reports/experiments_latest.md` if they exist.
